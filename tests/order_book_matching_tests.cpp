...
TEST_F(OrderBookMatchingTest, BuyOrderRestsWhenNoAsks) {
    ...
    book.addLimitOrder(Side::Buy, 100, 50, 1);
...
TEST_F(OrderBookMatchingTest, SellOrderRestsWhenNoBids) {
    ...
    book.addLimitOrder(Side::Sell, 100, 50, 1);
...
TEST_F(OrderBookMatchingTest, BuyOrderRestsWhenPriceBelowBestAsk) {
    ...
    book.addLimitOrder(Side::Sell, 100, 50, 1);  // ask @ 100
    book.addLimitOrder(Side::Buy, 99, 50, 2);    // buy @ 99, no cross
...
TEST_F(OrderBookMatchingTest, SellOrderRestsWhenPriceAboveBestBid) {
    ...
    book.addLimitOrder(Side::Buy, 100, 50, 1);   // bid @ 100
    book.addLimitOrder(Side::Sell, 101, 50, 2);  // sell @ 101, no cross
...
TEST_F(OrderBookMatchingTest, BuyExactlyFillsSell) {
    ...
    book.addLimitOrder(Side::Sell, 100, 50, 1);
    book.addLimitOrder(Side::Buy, 100, 50, 2);
...
TEST_F(OrderBookMatchingTest, SellExactlyFillsBuy) {
    ...
    book.addLimitOrder(Side::Buy, 100, 50, 1);
    book.addLimitOrder(Side::Sell, 100, 50, 2);
...
TEST_F(OrderBookMatchingTest, BuyPartiallyFillsRemainderRests) {
    ...
    book.addLimitOrder(Side::Sell, 100, 30, 1);  // resting 30
    book.addLimitOrder(Side::Buy, 100, 50, 2);   // incoming 50
...
TEST_F(OrderBookMatchingTest, SellPartiallyFillsRemainderRests) {
    ...
    book.addLimitOrder(Side::Buy, 100, 30, 1);   // resting 30
    book.addLimitOrder(Side::Sell, 100, 50, 2);  // incoming 50
...
TEST_F(OrderBookMatchingTest, BuyPartiallyFillsRestingRemains) {
    ...
    book.addLimitOrder(Side::Sell, 100, 50, 1);  // resting 50
    book.addLimitOrder(Side::Buy, 100, 30, 2);   // incoming 30
...
TEST_F(OrderBookMatchingTest, SellPartiallyFillsRestingRemains) {
    ...
    book.addLimitOrder(Side::Buy, 100, 50, 1);   // resting 50
    book.addLimitOrder(Side::Sell, 100, 30, 2);  // incoming 30
...
TEST_F(OrderBookMatchingTest, BuySweepsMultipleOrdersSamePriceFIFO) {
    ...
    book.addLimitOrder(Side::Sell, 100, 20, 1);  // first
    book.addLimitOrder(Side::Sell, 100, 30, 2);  // second
    book.addLimitOrder(Side::Buy, 100, 40, 3);   // sweeps first fully, second partially
...
TEST_F(OrderBookMatchingTest, SellSweepsMultipleOrdersSamePriceFIFO) {
    ...
    book.addLimitOrder(Side::Buy, 100, 20, 1);   // first
    book.addLimitOrder(Side::Buy, 100, 30, 2);   // second
    book.addLimitOrder(Side::Sell, 100, 40, 3);  // sweeps first fully, second partially
...
TEST_F(OrderBookMatchingTest, BuySweepsMultiplePriceLevelsBestFirst) {
    ...
    book.addLimitOrder(Side::Sell, 100, 20, 1);  // best ask
    book.addLimitOrder(Side::Sell, 101, 30, 2);  // worse ask
    book.addLimitOrder(Side::Buy, 101, 40, 3);   // sweeps 100@20, then 101@20
...
TEST_F(OrderBookMatchingTest, SellSweepsMultiplePriceLevelsBestFirst) {
    ...
    book.addLimitOrder(Side::Buy, 101, 20, 1);  // best bid
    book.addLimitOrder(Side::Buy, 100, 30, 2);  // worse bid
    book.addLimitOrder(Side::Sell, 100, 40, 3); // sweeps 101@20, then 100@20
...
TEST_F(OrderBookMatchingTest, BuyWithPriceImprovementMatchesAtAskPrice) {
    ...
    book.addLimitOrder(Side::Sell, 100, 50, 1);
    book.addLimitOrder(Side::Buy, 105, 50, 2);  // willing to pay more

    ASSERT_EQ(trades_.size(), 1);
    EXPECT_EQ(trades_[0].price, 100);  // trades at resting price
    EXPECT_EQ(trades_[0].quantity, 50);
}
...
TEST_F(OrderBookMatchingTest, SellWithPriceImprovementMatchesAtBidPrice) {
    ...
    book.addLimitOrder(Side::Buy, 100, 50, 1);
    book.addLimitOrder(Side::Sell, 95, 50, 2);  // willing to accept less
...
TEST_F(OrderBookMatchingTest, PriceLevelRemovedWhenAllOrdersFilled) {
    ...
    book.addLimitOrder(Side::Sell, 100, 20, 1);
    book.addLimitOrder(Side::Sell, 100, 30, 2);
    book.addLimitOrder(Side::Buy, 100, 50, 3);  // fills both completely

    ASSERT_EQ(trades_.size(), 2);
    EXPECT_EQ(book.bestAsk(), nullptr);  // price level 100 removed
}

TEST_F(OrderBookMatchingTest, MultiplePriceLevelsOrdered) {
    OrderBook book(10, captureCallback());

    book.addLimitOrder(Side::Buy, 100, 10, 1);
    book.addLimitOrder(Side::Buy, 102, 10, 2);  // best bid
    book.addLimitOrder(Side::Buy, 101, 10, 3);

    book.addLimitOrder(Side::Sell, 105, 10, 4);
    book.addLimitOrder(Side::Sell, 103, 10, 5);  // best ask
    book.addLimitOrder(Side::Sell, 104, 10, 6);
